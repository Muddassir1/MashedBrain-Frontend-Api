    ...
    <div class="col-12">
        <div class="card-header pb-0 row align-items-center mb-4">
            ...
            <div class="col-6 text-md-end">
                ...
                <a href="#" class="btn btn-primary btn-hover-outline font-weight-normal mb-0 border-primary border w-25" onclick="$('#publish-book').submit();return false;">
                    @if(isset($update)) Update @else Publish @endif
                </a>
            </div>
        </div>
        <form id="publish-book" class="add-form" role="form" method="POST" action={{ route('books.publish') }} enctype="multipart/form-data">
            @csrf
