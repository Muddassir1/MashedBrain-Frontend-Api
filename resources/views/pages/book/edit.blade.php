...
@section('content')
    ...
    <div class="row mt-4 mx-4">
        <div class="col-12">
            ...
            <div class="card">
                <form id="book-add-form" class="add-form" role="form" method="POST"
                                            ...
                                            <select class="form-control" name="category">
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        @if ($category->id == $book->category) selected @endif>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="recommended">
                                                <option value="0" @if (!$book->recommended) selected @endif>No
                                                </option>
                                                <option value="1" @if ($book->recommended) selected @endif>Yes
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="popular">
                                                <option value="0" @if (!$book->popular) selected @endif>No
                                                </option>
                                                <option value="1" @if ($book->popular) selected @endif>Yes
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <img src="{{ asset($book->image_path ? $book->image_path : 'img/book-img-upload.png') }}"
