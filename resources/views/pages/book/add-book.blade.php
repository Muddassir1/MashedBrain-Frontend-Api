...
<div class="row mt-4 mx-4">
    <div class="col-12">
        ...
        <div class="card">
            <form id="book-add-form" class="add-form" role="form" method="POST" action={{ route('books.store') }} enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <img src="{{asset('img/book-img-upload.png')}}" class="w-100 cursor-pointer img-upload-btn" />
