...
@section('content')
    ...
    <div class="row mt-4 mx-4">
        <div class="col-12">
            <div class="card-header pb-3 row align-items-center">
                ...
                <div class="col-sm-6 col-12 mt-3 mt-sm-0 text-md-end">
                    <a href="#"
                        class="btn btn-primary btn-hover-outline font-weight-normal mb-0 w-100 w-sm-auto border-primary border"
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        <td>
                                            <div class="d-flex px-3 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm text-dark font-weight-normal">{{ $user->name }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <p class="text-sm font-weight-normal mb-0">{{ $user->get_access_level_name() }}
                                            </p>
                                        </td>
                                        <td class="align-middle">
                                            <p class="text-sm text-dark mb-0">
                                                <a href="{{ route('users.edit', $user->id) }}"
                                                    class="btn btn-outline-primary btn-outline-blue text-bold me-2 mb-0">Edit</a>
                                                <button class="btn btn-outline-danger text-bold  mb-0"
    ...
    <!-- Modal -->
    <div class="modal fade" id="moderationModal" tabindex="-1" role="dialog" aria-labelledby="moderationModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content px-2">
                ...
                <div class="modal-body">
                    <form class="modal-form" role="form" method="POST" action={{ route('users.store') }}
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <button type="button" class="btn btn-primary font-weight-normal w-100"
