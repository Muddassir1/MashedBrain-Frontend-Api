...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl
    ...
    <div class="container-fluid py-1 px-3">
        <h5 class="text-white me-sm-5 mb-0"><span class="color-gray">Welcome,</span> <span class="text-primary font-weight-bolder">{{auth()->user()->name}}</span></h5>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            <div class="pe-md-3 d-flex align-items-center w-md-50">
                <div class="input-group search-bar-top">
                    <span class="input-group-text text-body border-radius-top-start-pill border-radius-bottom-start-pill"><i class="fal fa-search font-weight-bold" aria-hidden="true"></i></span>
                    <input type="text" class="form-control border-radius-top-end-pill border-radius-bottom-end-pill" placeholder="Search Here">
                </div>
            </div>
            <ul class="navbar-nav  justify-content-end">
                <li class="nav-item dropdown pe-2 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-white bell-nav p-3 rounded-circle" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <li class="mb-2">
                            <a class="dropdown-item border-radius-md" href="javascript:;">
                                <div class="d-flex py-1">
                                    <div class="my-auto">
                                        <img src="{{asset(auth()->user()->avatar)}}" class="avatar avatar-sm  me-3 ">
                                    </div>
